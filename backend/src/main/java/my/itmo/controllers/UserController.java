...
import my.itmo.network.ConfirmProfileRequest;
...
public class UserController {
    ...
    @PostMapping(value = "/confirmProfile")
    public ResponseEntity confirmProfile(@RequestBody @Valid ConfirmProfileRequest confirmRequest) {
        log.info("Пришёл запрос на подтверждение почты");
        return userService.checkCacheUser(confirmRequest);
    }
